...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        var course = new Course(lecturers, "ВВП", 1234, 321);
        ...
        var project = new Project("Рандомайзер", new Date(123456789), new Date(999999999));

        var assistant = new ResearchAssociate("Некипелов","Математика");

        var admin = new AdministrativeEmployee("Коротаев");
